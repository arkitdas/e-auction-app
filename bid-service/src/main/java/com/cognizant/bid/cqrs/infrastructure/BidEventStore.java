...
import com.cognizant.bid.cqrs.events.EventStoreRepository;
...
@Service
public class BidEventStore implements EventStore {
    
	private EventProducer eventProducer;
    private EventStoreRepository eventStoreRepository;
    
    BidEventStore(EventProducer eventProducer, EventStoreRepository eventStoreRepository) {
