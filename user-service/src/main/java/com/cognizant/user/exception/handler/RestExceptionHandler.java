package com.cognizant.user.exception.handler;
...
import com.cognizant.user.exception.InvalidOperationException;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<?> handleFileNotUploadedException(UserNotFoundException ex, WebRequest request) throws Exception {
    	log.error("exception details: {}", ex);
        return new ResponseEntity<Object>(ApiResponse.ofFailure(HttpStatus.NOT_FOUND.value(), ex.getMessage()), HttpStatus.NOT_FOUND);
    }
}
