package com.cognizant.seller.exception.handler;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<?> handleFileNotUploadedException(SellerNotFoundException ex, WebRequest request) throws Exception {
    	log.error("exception details: {}", ex);
        return new ResponseEntity<Object>(ApiResponse.ofFailure(HttpStatus.NOT_FOUND.value(), ex.getMessage()), HttpStatus.NOT_FOUND);
    }
