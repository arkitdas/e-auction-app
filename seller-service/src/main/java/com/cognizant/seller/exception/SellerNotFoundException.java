package com.cognizant.seller.exception;
...
public class SellerNotFoundException extends Exception{
	...
	public SellerNotFoundException(int code, String message) {
	...
	public SellerNotFoundException(int code, String message, Throwable cause) {
		this.code = code;
